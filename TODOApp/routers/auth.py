...
# this must be read from a env var
SECRET_KEY = '05052b1a7af624fe4e57797fb9db60da84a3820e0e872c492326ce0aa1f409ea'
ALGORITHM = 'HS256'
...
def create_access_token(username: str, user_id: int, role: str, expire_delta: timedelta):
    ...
    encode = {"sub": username, 'id': user_id, 'role': role, 'exp': expires + expire_delta}
